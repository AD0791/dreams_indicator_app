...
base_ind = base[
    (base.test_results == "3,") |
    (base.test_results == "2,,3,") |
    (base.test_results == "0,,2,,3,") |
    (base.test_results == "0,,3,")
]

hts_ind = hts[
    (hts.test_results == "3,") |
    (hts.test_results == "2,,3,") |
    (hts.test_results == "0,,2,,3,") |
    (hts.test_results == "0,,3,")
]

# TODO retirer les personnes deja sensibilises pour la prep
